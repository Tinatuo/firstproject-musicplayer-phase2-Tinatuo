...
public class Premium extends Listener {
    ...
    public Premium(double accountCredit, int endYear, int endMounth, int endDay, ArrayList<Genre> favoriteGenre, String userName, String password, String firstAndLastname, String phoneNumber, int year, int mounth, int day, String email, int remainingDays,String imageView) {
